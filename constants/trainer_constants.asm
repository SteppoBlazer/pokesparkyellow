...
const_value = 1
	...
	trainer_const SWIMMERF      ; $0D | OPP = $D5
	...
	trainer_const BUG_CATCHERF  ; $1B | OPP = $E3
	...
	trainer_const PSYCHICF
	trainer_const BIRDKEEPERF
	trainer_const BLACKBELTF
	trainer_const SCIENTISTF
	trainer_const ROCKETF
