HiddenObjectMaps:
	...
	dbw POKEMON_MANSION_4F,     Mansion4HiddenObjects
	dbw SAFARI_ZONE_WEST,       SafariZoneWestHiddenObjects
	dbw CERULEAN_CAVE_2F,       UnknownDungeon2HiddenObjects
	dbw CERULEAN_CAVE_B1F,      UnknownDungeon3HiddenObjects
	...
	dbw CERULEAN_CAVE_1F,       UnknownDungeon1HiddenObjects
