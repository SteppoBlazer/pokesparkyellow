...
MasaraTown_Coll::   INCLUDE  "gfx/tilesets/masaratown.asm"
TokiwaCity_Coll::   INCLUDE  "gfx/tilesets/tokiwacity.asm"
NibiCity_Coll::     INCLUDE  "gfx/tilesets/nibicity.asm"
HanadaCity_Coll::   INCLUDE  "gfx/tilesets/hanadacity.asm"
