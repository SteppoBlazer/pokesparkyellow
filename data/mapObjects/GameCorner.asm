CeladonGameCornerObject:
	...
	db 3 ; warps
	warp 17, 15, 6, CELADON_CITY
	warp 17, 16, 6, CELADON_CITY
	...
	object SPRITE_FAT_BALD_GUY, 14, $b, STAY, LEFT, 9 ; person
	object SPRITE_FISHER, 17, 13, STAY, RIGHT, 10 ; person
	object SPRITE_ROCKET, 9, 5, STAY, UP, 11, OPP_ROCKET, 7

	; warp-to
	warp_to 17, 15, GAME_CORNER_WIDTH
	warp_to 17, 16, GAME_CORNER_WIDTH
	warp_to 4, 17, GAME_CORNER_WIDTH ; ROCKET_HIDEOUT_1
