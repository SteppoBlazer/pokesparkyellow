UnknownDungeon1Object:
	...
	db 4 ; objects
	object SPRITE_BALL,  1,  7, STAY, NONE, 1, RARE_CANDY
	object SPRITE_BALL,  9, 17, STAY, NONE, 2, MAX_ELIXER
	object SPRITE_BALL, 19, 12, STAY, NONE, 3, MAX_REVIVE
	object SPRITE_BALL, 14,  0, STAY, NONE, 4, ULTRA_BALL
