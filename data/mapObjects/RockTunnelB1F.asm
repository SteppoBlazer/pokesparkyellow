RockTunnel2Object:
	...
	object SPRITE_COSPLAYERM, 3, 5, STAY, DOWN, 3, OPP_POKEMANIAC, 3
	object SPRITE_COSPLAYERM, 20, 21, STAY, RIGHT, 4, OPP_POKEMANIAC, 4
	...
	object SPRITE_COSPLAYERM, 26, 30, STAY, DOWN, 8, OPP_POKEMANIAC, 5
