UnknownDungeon2Object:
	...
	db 4 ; objects
	object SPRITE_BALL,  0,  5, STAY, NONE, 1, RARE_CANDY
	object SPRITE_BALL, 14,  2, STAY, NONE, 2, ULTRA_BALL
	object SPRITE_BALL, 15, 17, STAY, NONE, 3, MAX_REVIVE
	object SPRITE_BALL, 29,  9, STAY, NONE, 4, FULL_RESTORE
