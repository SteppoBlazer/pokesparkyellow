Route10Object:
	...
	db 3 ; signs
	sign  6, 18, 7 ; Route10Text7 ;POWER_PLANT
	sign 10, 17, 8 ; PokeCenterSignText ;POWER_PLANT
	;sign 9, 55, 9 ; Route10Text9
	sign  2, 32, 9 ; Route10Text10

	db 2 ; objects
	object SPRITE_BLACK_HAIR_BOY_2, 10, 33, STAY, LEFT, 1, OPP_POKEMANIAC, 1;POWER_PLANT
	;object SPRITE_HIKER, 3, 57, STAY, UP, 2, OPP_HIKER, 7
	;object SPRITE_BLACK_HAIR_BOY_2, 14, 64, STAY, LEFT, 3, OPP_POKEMANIAC, 2
	object SPRITE_LASS, 14, 20, STAY, LEFT, 4, OPP_JR_TRAINER_F, 7 ;POWER_PLANT
