CeladonCityObject:
	...
	sign 39, 21, 10 ; CeladonCityText16
	sign 33, 21, 11 ; CeladonCityText17
	sign 27, 21, 12 ; CeladonCityText18
	...
	; warp_to
	warp_to 8, 13, CELADON_CITY_WIDTH
	warp_to 10, 13, CELADON_CITY_WIDTH
	warp_to 24, 9, CELADON_CITY_WIDTH
	warp_to 24, 3, CELADON_CITY_WIDTH
	warp_to 25, 3, CELADON_CITY_WIDTH
	warp_to 41, 9, CELADON_CITY_WIDTH
	warp_to 12, 27, CELADON_CITY_WIDTH
	warp_to 28, 19, CELADON_CITY_WIDTH
	warp_to 39, 19, CELADON_CITY_WIDTH
	warp_to 33, 19, CELADON_CITY_WIDTH
	warp_to 31, 27, CELADON_CITY_WIDTH
	warp_to 35, 27, CELADON_CITY_WIDTH
	warp_to 43, 27, CELADON_CITY_WIDTH
