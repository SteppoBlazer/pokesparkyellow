CeruleanCityObject:
	...
	warp  2, 11, 0, UNKNOWN_DUNGEON_1
	warp 27, 9, 2, TRASHED_HOUSE
	warp 11, 11, 1, CERULEAN_HOUSE_2
	warp 11,  7, 0, CERULEAN_HOUSE_2
	...
	sign 21, 23, 17 ; CeruleanCityText17
	...
	object SPRITE_BLACK_HAIR_BOY_2, 18, 23, WALK, 1, 4 ; person
	...
	object SPRITE_LASS,  7, 27, WALK, 2, 9 ; person
	object SPRITE_BLACK_HAIR_BOY_2,  2, 12, STAY, DOWN, 10 ; person
	...
	warp_to  2, 11, CERULEAN_CITY_WIDTH ; UNKNOWN_DUNGEON_1
	warp_to 27, 9, CERULEAN_CITY_WIDTH ; TRASHED_HOUSE
	warp_to 11, 11, CERULEAN_CITY_WIDTH ; CERULEAN_HOUSE_2
	warp_to 11,  7, CERULEAN_CITY_WIDTH ; CERULEAN_HOUSE_2
